...
<?php if ($_POST['passe']==NULL OR $_POST['passe']!="maitrise")
 ...
 <body>
  <h1>
   <center><font color="orange">Planning Louveteaux/Jeannettes</font></center>
  </h1>
  ...
  <?php $id=$_GET['id'];
        if ($_GET['id']==NULL)
		 {$id=$_POST['id'];}?>
  <form method="POST" action="chefl.php">
  ...
  <a href="planningl.php"> planning</a>
    </body>
 </html>
...
<html>
 ...
 <body>
  ...
  <form method="POST" action="planningl.php">
