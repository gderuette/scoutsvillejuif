...
<?php if ($_POST['passe']==NULL OR $_POST['passe']!="maitrise")
 ...
 <body>
  <h1>
   <center><font color="red">Planning Pionniers/Caravelles</font></center>
  </h1>
  ...
  <?php $id=$_GET['id'];
        if ($_GET['id']==NULL)
		 {$id=$_POST['id'];}?>
  <form method="POST" action="chefp.php">
  ...
  <a href="planningp.php"> planning</a>
    </body>
 </html>
...
<html>
 ...
 <body>
  ...
  <form method="POST" action="planningp.php">
