...
<div class="corpsbis">
<h1>
<center><font color="orange">Planning Louvetaux-Jeannettes</font></center>
</h1>
<table border="1">
	<tr>
		<th>Dates</th>
	...
	supprimerReunionObsolete(planninglouveteau);

	$table=afficherPlanning("planninglouveteau");
	...
	while ($donnees = mysql_fetch_array($table))
	{
		...
		if ($isChef)
		{
			$id=$donnees['id'];
			?>
	<td><a href="modifl.php?id=<?php echo "$id"; ?>">modifier </a><a
		href="supprimerReunion.php?id=<?php echo "$id"; ?>&amp;quelPlanning=planninglouveteau">
	supprimer</a></td>
	<?php
		}
		echo "</tr>";
...
<br />
	...
	<?php
	if ($isChef)
	echo "<a href='modifl.php'>ajouter</a>";
	else
	echo "<a href='partieProtege.php'>modifier</a>";
	?> <br />
<br />

<a href="planningpdf/planning_lvtx.pdf"><img src="img_pdf.png" alt="pdf"
	border="0" /> planning louveteaux et jeannettes</a>
