...
Calendar._TT = {};
Calendar._TT["TOGGLE"] = "Changer 1er jour de la semaine";
Calendar._TT["PREV_YEAR"] = "Année préc. (clic long : menu)";
Calendar._TT["PREV_MONTH"] = "Mois préc. (clic long : menu)";
Calendar._TT["GO_TODAY"] = "Aujourd'hui";
Calendar._TT["NEXT_MONTH"] = "Mois suiv. (clic long : menu)";
Calendar._TT["NEXT_YEAR"] = "Année suiv. (clic long : menu)";
Calendar._TT["SEL_DATE"] = "Sélectionner une date";
Calendar._TT["DRAG_TO_MOVE"] = "Glisser déplacer";
Calendar._TT["PART_TODAY"] = " (aujourd'hui)";
Calendar._TT["MON_FIRST"] = "Lundi en premier";
Calendar._TT["SUN_FIRST"] = "Dimanche en premier";
...
function showCalendar(id, format) {
  ...
  if (calendar != null) {
    ...
    cal.setRange(2007, 2070);        // min/max year allowed.
    cal.create();
  }
